      ...
      return React.createElement('div', { style: s.wrap },
        ...
        React.createElement('div', { style: s.section },
          ...
          React.createElement('div', { style: s.keyLine },
            React.createElement('span', { style: s.masked }, hasKey ? '已配置' : '未配置'),
          ),
        ...
        React.createElement('div', { style: s.section },
          ...
          hasToken
            ? React.createElement('div', { style: s.keyLine },
                React.createElement('span', { style: s.note }, '当前：已配置（手动输入）'),
          ...
          React.createElement('div', { style: s.note }, '获取：登录 platform.deepseek.com 后，在浏览器控制台执行 localStorage.getItem("userToken")，再手动粘贴到这里。插件不会扫描浏览器数据。'),
        ),
